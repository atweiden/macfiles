...
g:sexp_filetypes = join(keys(g:lispft), ',')

# don't automatically enter insert mode after wrapping
g:sexp_insert_after_wrap = 0

g:sexp_mappings = { sexp_outer_list:                'af',
                    sexp_inner_list:                'if',
                    ...
                    sexp_move_to_next_element_head: '<M-D>',
                    sexp_move_to_prev_element_tail: '<M-W>',
                    sexp_move_to_next_element_tail: '<M-S>',
                    sexp_flow_to_prev_close:        'g)',
                    sexp_flow_to_next_open:         'g(',
                    sexp_flow_to_prev_open:         '(',
                    sexp_flow_to_next_close:        ')',
                    sexp_flow_to_prev_leaf_head:    '<M-a>',
                    sexp_flow_to_next_leaf_head:    '<M-d>',
                    sexp_flow_to_prev_leaf_tail:    '<M-w>',
                    sexp_flow_to_next_leaf_tail:    '<M-s>',
