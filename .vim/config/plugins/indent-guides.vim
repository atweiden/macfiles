...
augroup indent-guides
  autocmd!
  autocmd VimEnter,Colorscheme * :highlight IndentGuidesOdd guibg=#FBFBFB ctermbg=234
  autocmd VimEnter,Colorscheme * :highlight IndentGuidesEven guibg=#F7F7F7 ctermbg=235
augroup END
